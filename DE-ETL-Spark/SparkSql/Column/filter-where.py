...
# loc cac ban ghi theo dieu kien
# jsonFile.where("actor.id < 20000").show()

jsonFile.select(col("id"), col("actor.id").alias("actor_id")).filter((col("id") == "2615567732") & (col("actor_id") == "19299")).show()
jsonFile.filter(length(col("id")) < 11).show()